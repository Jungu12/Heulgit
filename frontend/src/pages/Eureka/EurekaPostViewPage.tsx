...
import EurekaPostViewFeedTablet from './EurekaPostViewFeedTablet';
import EurekaPostViewFeedPC from './EurekaPostViewFeedPC';
			...
			<Tablet>
				<StyledEurekaPostViewTablet>
					...
					<CommunityContainerTablet>
						<EurekaPostViewFeedTablet feed={dummyPost} />
						<EurekaPostCommentList comments={dummyComment} />
						<CommentInput />
					</CommunityContainerTablet>
					<StyledMenuContainerTablet />
			...
			<PC>
				<StyledEurekaPostViewPC>
					...
					<CommunityContainerPC>
						<EurekaPostViewFeedPC feed={dummyPost} />
						<EurekaPostCommentList comments={dummyComment} />
						<CommentInput />
					</CommunityContainerPC>
					<StyledMenuContainerPC />
