...
import FreeBoardContentInput from '../community/FreeBoardContentInput';
import { FreeBoardWriteType } from '@typedef/community/freeboard.types';
import FreeBoardTitleInput from '../community/FreeBoardTitleInput';
