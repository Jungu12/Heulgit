...
// 선택된 게시판 이름
const StyledSelectedCommunityName = styled.img`
	display: flex;
	align-items: center;
	...
	return (
		<StlyedCommunityFilterContainer>
			<StyledCommunityCategoryContainer>
				<StyledSelectedCommunityName src={images.logo} alt="로고" />
...
export default CommunityMenuBarTablet;
